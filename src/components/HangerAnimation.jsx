...
export function HangerAnimation({ isRestocking = true }) {
  ...
  return (
    <div className="relative w-full max-w-[340px] sm:max-w-[400px] h-[220px] sm:h-[260px] flex items-start justify-center select-none mx-auto overflow-visible">
      ...
      <div className="absolute top-0 z-10 flex flex-col items-center pointer-events-none">
        ...
        <div className="w-52 sm:w-72 h-1.5 bg-gradient-to-r from-transparent via-zinc-400 to-transparent rounded-full opacity-90 shadow-[0_1px_6px_rgba(0,0,0,0.9)]" />
      </div>

      {/* Main Pendulum: Clothes Hanger Assembly */}
      <motion.div
        className="relative flex flex-col items-center cursor-grab active:cursor-grabbing z-20 scale-95 sm:scale-100 origin-top"
        style={{
      ...
      >
        ...
        <svg
          viewBox="0 0 280 114"
          className="w-[210px] sm:w-[240px] h-auto drop-shadow-[0_10px_20px_rgba(0,0,0,0.7)] overflow-visible"
          fill="none"
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <div className="w-[1.5px] h-4 sm:h-5 bg-gradient-to-b from-zinc-400 via-zinc-300 to-zinc-500" />
            <div className="w-3.5 h-1.5 rounded-full border border-zinc-400 bg-zinc-800 -mb-1 shadow-xs" />
          </div>

          {/* Garment Tag Card */}
          <div className="relative w-[200px] sm:w-[220px] bg-[#121214] border border-zinc-700/90 rounded-md p-3 sm:p-3.5 text-zinc-100 shadow-[0_16px_32px_-8px_rgba(0,0,0,0.9)] backdrop-blur-md overflow-hidden">
            {/* Eyelet Hole */}
            <div className="absolute top-2 left-1/2 -translate-x-1/2 flex items-center justify-center">
              <div className="w-3.5 h-3.5 rounded-full border border-zinc-400 bg-[#0d0d0d] shadow-inner flex items-center justify-center">
                <div className="w-1.5 h-1.5 rounded-full bg-zinc-700" />
              </div>
            </div>

            {/* Tag Header: Brand Mark LATE90S */}
            <div className="text-center pt-1.5 px-1">
              <span className="font-['Bebas_Neue',sans-serif] text-xl sm:text-2xl tracking-[0.22em] text-white block leading-none">
                LATE<span className="text-[#c8a96e]">90S</span>
              </span>
              <span className="text-[8.5px] font-mono-custom tracking-[0.22em] text-zinc-400 uppercase mt-1 block">
                COLLECTION 2026
              </span>
            </div>
            ...
            <div className="mt-2 flex items-center justify-center">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-[#09090b] border border-emerald-500/40 shadow-xs">
                ...
                <span className="text-[9px] font-mono-custom tracking-wider text-emerald-300 font-bold uppercase">
                  [ STORE MAINTENANCE ]
                </span>
              </div>
            </div>
            ...
            <div className="mt-2 px-0.5 flex flex-col gap-1">
              <div className="flex items-center justify-between text-[8px] font-mono-custom">
              ...
              <div className="relative w-full h-[3px] bg-zinc-900 border border-zinc-800 rounded-full overflow-hidden">
                <motion.div
                  className="absolute top-0 bottom-0 bg-gradient-to-r from-transparent via-emerald-400 to-transparent w-16 rounded-full shadow-[0_0_8px_rgba(52,211,153,1)]"
                  animate={
                    shouldReduceMotion
                      ? { left: '35%' }
                      : {
            ...
            {/* Tag Specs */}
            <div className="mt-2 pt-2 border-t border-zinc-800 text-[8.5px] font-mono-custom text-zinc-400 flex justify-between items-center">
              <span className="text-zinc-500 font-semibold">ORIGIN:</span>
              <span className="text-zinc-200 font-bold">DHARGA TOWN, LK</span>
            </div>

            {/* Barcode */}
            <div className="mt-2 pt-1.5 border-t border-dashed border-zinc-800 flex flex-col items-center">
              ...
              <span className="text-[7.5px] font-mono-custom tracking-[0.22em] text-zinc-400 mt-0.5">
                90 2026 0119 LK
              </span>
            </div>
          </div>
