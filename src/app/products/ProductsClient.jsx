...
const FALLBACK_CATEGORIES = ['T-Shirts', 'Pants']
const SORT_OPTIONS = [
...
export default function ProductsClient({ initialProducts = [], initialCategories = [] }) {
  ...
  useEffect(() => { setPage(1) }, [activeCategory, activeSize, sort])
      ...
      <div className="products-header" style={{
        ...
        <div style={{ maxWidth: '1300px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <motion.div
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '1.25rem' }}
          >
            <div style={{
              ...
              <span style={{
                fontSize: '0.58rem', letterSpacing: '0.3em', color: 'var(--gold)',
                textTransform: 'uppercase', fontFamily: 'var(--font-inter)', fontWeight: 600,
              }}>Sri Lankan Streetwear</span>
            </div>
            <span style={{
            ...
            {['The', 'Collection.'].map((word, i) => (
              <motion.h1
                ...
                style={{
                  ...
                  letterSpacing: '0.01em', lineHeight: 0.95, display: 'block',
                }}
              >{word}</motion.h1>
            ))}
          </div>
          ...
          <motion.div
            ...
            style={{ height: '1px', backgroundColor: 'var(--border)', marginTop: '2rem', transformOrigin: 'left' }}
          />
        </div>
      </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--text)', padding: '0.45rem 1rem',
            ...
            {['all', ...SIZES].map(size => (
              <button
                ...
                style={{
                  ...
                  transition: 'all 0.15s ease', minWidth: '30px', textAlign: 'center',
                }}
          ...
          {hasActiveFilters && (
            <button
              ...
              style={{
                ...
                color: 'var(--subtitle)', fontFamily: 'var(--font-inter)',
          ...
          {loading ? (
            <div style={{
              ...
              {Array(6).fill(0).map((_, i) => (
                <div key={i}>
                  ...
                  <div style={{ paddingTop: '0.9rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                    <div style={{ height: '7px', width: '55px', backgroundColor: 'var(--border)', borderRadius: '1px' }} />
                    <div style={{ height: '20px', width: '130px', backgroundColor: 'var(--border)', borderRadius: '1px' }} />
                    <div style={{ height: '9px', width: '75px', backgroundColor: 'var(--border)', borderRadius: '1px' }} />
                    <div style={{ height: '36px', backgroundColor: 'var(--border)', borderRadius: '1px', marginTop: '0.4rem' }} />
                  </div>
                </div>
              ))}
            </div>
            ...
            >
              <div style={{
                ...
                color: 'var(--border)', letterSpacing: '0.05em', lineHeight: 1,
                marginBottom: '1rem',
              }}>EMPTY</div>
              <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.85rem', color: 'var(--subtitle)', marginBottom: '1.5rem' }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '0.75rem 2rem', fontFamily: 'var(--font-inter)',
